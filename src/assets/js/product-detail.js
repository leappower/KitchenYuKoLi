...
(function () {
  ...
  function renderPDP() {
    ...
    var html = '<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex flex-col lg:flex-row gap-8 lg:items-start">' +
      ...
      '<a href="https://wa.me/' + wa + '?text=' + encodeURIComponent((product.subCategory || product.categoryName || product.model) + ' ' + product.model) + '" target="_blank" class="px-6 py-3 rounded-xl font-bold flex items-center gap-2 border-2 border-slate-300 dark:border-slate-600 hover:border-primary hover:text-primary transition-all text-sm"><span class="material-symbols-outlined text-lg">chat</span> 联系销售</a></div></div></div>' +
