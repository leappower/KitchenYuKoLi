! function(e) {
  ...
  function i() {
    ...
    }, !0), e.ProductsDropdown && e.ProductsDropdown.initDropdownClick(), e.SolutionsDropdown && e.SolutionsDropdown.initDropdownClick(), e.ApplicationsDropdown && e.ApplicationsDropdown.initDropdownClick(), e.SupportDropdown && e.SupportDropdown.initDropdownClick(), e.AboutDropdown && e.AboutDropdown.initDropdownClick(), e.ContactDropdown && e.ContactDropdown.initDropdownClick(), e.translationManager && ("function" == typeof e.translationManager.applyTranslations && e.translationManager.applyTranslations(), "function" == typeof e.translationManager.setupEventListeners && e.translationManager.setupEventListeners()), console.log("[navigator] MobileMenu exists:", !!e.SlideMenu, "| initToggle:", typeof(e.SlideMenu && e.SlideMenu.initToggle)), e.SlideMenu && ("function" == typeof e.SlideMenu.initToggle && (e.SlideMenu.initToggle(), console.log("[navigator] MobileMenu.initToggle() called")), "function" == typeof e.SlideMenu.initSmartHeader && e.SlideMenu.initSmartHeader());
