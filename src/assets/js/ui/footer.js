...
(function (window) {
  ...
  function buildMobileFooterHtml() {
    return (
      ...
      '<div class="section-content mx-auto px-3 sm:px-5 py-4 sm:py-6" style="max-width:1920px">' +
  ...
  function buildPCFooterHtml() {
    return (
      '<div class="bg-slate-900 text-white">' +
      '<div class="section-content mx-auto px-3 sm:px-5 xl:px-10 pt-8 sm:pt-12 pb-6 sm:pb-8" style="max-width:1920px">' +
