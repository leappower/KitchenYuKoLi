...
(function (global) {
  ...
  function buildItem(sub, href) {
    ...
    var emojiHtml = sub.emoji
      ? '<span class="app-dropdown-emoji">' + sub.emoji + '</span>'
      : '';
    return '<a href="' + esc(href) + '" class="app-dropdown-item">' +
      '<span class="app-dropdown-icon">' +
        '<span class="material-symbols-outlined">' + esc(sub.icon) + '</span>' +
      '</span>' +
      '<span class="app-dropdown-label" data-i18n="' + esc(sub.key) + '">' + esc(sub.key) + '</span>' +
      emojiHtml +
      chevron +
    '</a>';
  }
  ...
  function renderDropdown(cfg) {
    ...
    var html = '<div class="app-dropdown-wrap' + (isTouch() ? ' touch-device' : '') + '">' +
      '<a href="' + esc(cfg.href) + '"' +
         ' class="' + esc(cfg.activeClass || '') + ' app-dropdown-trigger"' +
         ' data-app-trigger-label="' + esc(cfg.labelKey) + '">' +
  ...
  function initDropdownClick() {
    document.addEventListener('click', function () {
      document.querySelectorAll('.app-dropdown-wrap.is-open')
  ...
  function openPopup(href) {
    ...
    var items = SUBSERIES.map(function (s) {
      ...
      var emojiHtml = s.emoji
        ? '<span class="app-popup-emoji">' + s.emoji + '</span>'
        : '';
      return '<a href="' + esc(href) + '" class="app-popup-item">' +
        '<span class="app-dropdown-icon">' +
  ...
  function closePopup() {
    document.querySelectorAll('.app-popup-overlay,.app-popup-panel')
      .forEach(function (el) {
