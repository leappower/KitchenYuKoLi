...
(function (global) {
  ...
  var WA_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">' +
  ...
  function mount() {
    ...
    fab.innerHTML = WA_SVG + '<span class="wa-fab-tooltip" data-i18n="nav_contact_whatsapp_chat">Chat on WhatsApp</span>';
  ...
  global.WhatsAppFAB = {
    mount: mount,
    setNumber: function (n) { DEFAULT_NUMBER = n; },
    setMessage: function (m) { DEFAULT_MESSAGE = m; },
  };
