...
(function (global) {
  ...
  _mq768.addEventListener('change',    function (e) { mqMobile      = e.matches; global.MediaQueries.mqMobile      = e.matches; });
  _mq640.addEventListener('change',    function (e) { mqMobileSmall = e.matches; global.MediaQueries.mqMobileSmall = e.matches; });
  _mq1024.addEventListener('change',   function (e) { mqDesktop     = e.matches; global.MediaQueries.mqDesktop     = e.matches; });
  _mq768min.addEventListener('change', function (e) { mqTablet      = e.matches; global.MediaQueries.mqTablet      = e.matches; });

  global.MediaQueries = {
    get mqMobile()      { return mqMobile; },
    get mqMobileSmall() { return mqMobileSmall; },
    get mqDesktop()     { return mqDesktop; },
    get mqTablet()      { return mqTablet; },
    /** 返回当前是否为移动端（≤768px）。等同于 mqMobile，语义更直观。 */
    isMobile: function () { return mqMobile; }
  };
