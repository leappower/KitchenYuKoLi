...
(function () {
  ...
  function renderCardPc(c) {
    ...
    return (
      '<a href="/cases/' +
      c.slug +
      '/" class="case-card block bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all group border border-slate-200 dark:border-slate-700 hover:border-' +
      bc +
      '-500/50 flex flex-col cursor-pointer">' +
      "<!-- 上方图片 16:9 -->" +
  ...
  function renderCardMobile(c) {
    ...
    return (
      '<a href="/cases/' +
      c.slug +
      '/" class="case-card block bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-md border border-slate-200 dark:border-slate-700 cursor-pointer">' +
