! function(t) {
  ...
  function i(t, e, n) {
    return e = e || 1e4, n = n || "Translation loading timeout", Promise.race([t, new Promise(function(t, a) {
      setTimeout(function() {
        a(new Error(n))
      }, e)
    })])
  ...
  r.prototype.getInitialLanguage = function() {
    ...
    return this.pendingLoads.set(t, n), n.finally(function() {
      e.pendingLoads.delete(t)
    })
  }, r.prototype.fetchTranslations = function(t) {
    var e = this;
    return this.loadUITranslations(t).then(function(n) {
    ...
    return this.dropdownEl && document.contains(this.dropdownEl) || (this.dropdownEl = document.getElementById("language-dropdown")), this.dropdownEl
    ...
    return (this.translationsCache.has(e) ? Promise.resolve(this.translationsCache.get(e)) : this.loadUITranslations(this.currentLanguage)).then(function(e) {
      ...
      if (e) {
        ...
        if (n.forEach(function(t) {
          ...
          }), c.length > 0 && requestAnimationFrame(function() {
        ...
        t.updateCurrentLanguageLabel(t.currentLanguage), t.refreshCompanyName(e), t.refreshDocumentTitle(e), t.emit("translationsApplied", {
    ...
    e && "company_name" !== e || "zh-CN" !== this.currentLanguage || (e = "佛山市跃迁力科技有限公司"), e && "company_name" !== e && document.querySelectorAll('[data-i18n="company_name"]').forEach(function(t) {
    ...
    if (!document.getElementById("language-dropdown")) {
      if ("undefined" == typeof LanguageDropdownTemplate) {
        ...
        return a.src = "/assets/js/translations-dropdown-template.js", a.onload = function() {
    ...
    if (!this._eventListenersSetup) {
      ...
      if (document.addEventListener("click", function(n) {
        ...
        a && a.addEventListener("input", function(e) {
          t.filterLanguages(e.target.value)
        })
      }
  ...
  }, r.prototype.debug = function() {}, r.prototype.reloadTranslations = function() {
    var t = this.currentLanguage;
    this.translationsCache.delete(t), this.translationsCache.delete("ui-" + t), this.translationsCache.delete("product-" + t);
    var e = this;
    ...
    return this.currentLanguage = n, e.setupEventListeners(), Promise.all([this.loadUITranslations(n), this.loadProductTranslations(n).catch(function(t) {
      ...
      }), t.dispatchEvent(new CustomEvent("productTranslationsLoaded", {
        detail: {
          language: n
        }
      }))
    ...
    var t = this;
    return document.getElementById("language-dropdown") || (this.dropdownEl = null), this.setupEventListeners(), this.applyTranslations().then(function() {
