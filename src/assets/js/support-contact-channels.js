...
(function () {
  ...
  function renderWechatCard(cfg, device) {
    if (device === 'mobile') {
      return '<div class="flex items-center gap-3 p-4 rounded-xl bg-[#07C160] text-white transition-all duration-300 cursor-pointer active:scale-95" data-action="show-wechat-qr">' +
        '<div class="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center shrink-0">' + WECHAT_ICON + '</div>' +
        '<div class="flex-1"><p class="font-bold text-sm">微信</p><p class="text-xs text-white/80">' + cfg.wechat + '</p></div>' +
        '<span class="material-symbols-outlined text-white/60 text-lg shrink-0">qr_code_2</span>' +
      '</div>';
    }
    return '<div class="flex flex-col items-center gap-3 p-8 rounded-2xl bg-[#07C160]/5 border border-[#07C160]/20 hover:bg-[#07C160]/10 hover:shadow-lg hover:border-[#07C160]/40 transition-all duration-300 group cursor-pointer active:scale-95" data-action="show-wechat-qr">' +
      '<div class="w-14 h-14 rounded-full bg-[#07C160] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">' + WECHAT_ICON + '</div>' +
  ...
  function renderWaCard(cfg, device) {
    if (device === 'mobile') {
      return '<a href="https://wa.me/8613163756465" data-wa-source="contact-card" data-wa-message-key="wa_msg_support" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 p-4 rounded-xl bg-[#06C755]/10 border border-[#06C755]/20 transition-all active:scale-95">' +
    ...
    return '<a href="https://wa.me/8613163756465" data-wa-source="contact-card" data-wa-message-key="wa_msg_support" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center gap-3 p-8 rounded-2xl bg-[#06C755]/5 border border-[#06C755]/20 hover:bg-[#06C755]/10 hover:shadow-lg hover:border-[#06C755]/40 transition-all duration-300 group">' +
  ...
  function renderEmailCard(cfg, device) {
    if (device === 'mobile') {
      return '<a href="mailto:support.kitchen@yukoli.com" class="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all active:scale-95">' +
        ...
        '<div class="flex-1"><p class="font-bold text-sm text-slate-900 dark:text-slate-100">Email</p><p class="text-xs text-slate-500 dark:text-slate-400">' + (cfg.email || 'support.kitchen@yukoli.com') + '</p></div>' +
        '<span class="material-symbols-outlined text-slate-400 text-lg shrink-0">open_in_new</span>' +
      '</a>';
    }
    return '<a href="mailto:support.kitchen@yukoli.com" class="flex flex-col items-center gap-3 p-8 rounded-2xl bg-primary/5 border border-primary/20 hover:bg-primary/10 hover:shadow-lg hover:border-primary/40 transition-all duration-300 group">' +
  ...
  function renderPhoneCard(cfg, device) {
    if (device === 'mobile') {
      return '<a href="tel:+8613163756465" class="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all active:scale-95">' +
    ...
    return '<a href="tel:+8613163756465" class="flex flex-col items-center gap-3 p-8 rounded-2xl bg-blue-500/5 border border-blue-500/20 hover:bg-blue-500/10 hover:shadow-lg hover:border-blue-500/40 transition-all duration-300 group">' +
