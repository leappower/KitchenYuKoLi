...
(function () {
  ...
  var CONFIG = {
    support: {
      ...
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_support_wa", "Multi-language support, 2h reply on weekdays"),
      email: "support.kitchen@yukoli.com",
      phone: window.uiText("support_ch_support_phone", "Emergency support 24/7"),
    },
    faq: {
      titleKey: "support_faq_contact_title",
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_faq_wa", "Contact engineer"),
      email: window.uiText("support_ch_faq_email", "Submit a ticket"),
      phone: window.uiText("support_ch_faq_phone", "Emergency support"),
    },
    installation: {
      titleKey: "support_install_contact_title",
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_installation_wa", "Book installation consultation"),
      email: window.uiText("support_ch_installation_email", "Get installation plan"),
      phone: window.uiText("support_ch_installation_phone", "Urgent installation"),
    },
    "spare-parts": {
      titleKey: "support_spare_contact_title",
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_spare_parts_wa", "Parts consultation"),
      email: window.uiText("support_ch_spare_parts_email", "Order parts"),
      phone: window.uiText("support_ch_spare_parts_phone", "Urgent parts needed"),
    },
    training: {
      titleKey: "support_contact_channels_title",
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_training_wa", "Book training"),
      email: window.uiText("support_ch_training_email", "Get training materials"),
      phone: window.uiText("support_ch_training_phone", "Training inquiry"),
    },
    warranty: {
      titleKey: "support_warranty_contact_title",
      title: window.uiText("support_ch_support_title", "Contact Us"),
      wechat: window.uiText("support_ch_support_wechat", "Scan to add, chat online"),
      wa: window.uiText("support_ch_warranty_wa", "Warranty policy inquiry"),
      email: window.uiText("support_ch_warranty_email", "Warranty registration"),
      phone: window.uiText("support_ch_warranty_phone", "Fault report"),
    },
  };
