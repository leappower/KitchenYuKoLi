    ...
    cases: [
      {
        ...
        country: "Philippines",
        industry: window.t("app_chain_restaurant", "Chain Restaurant"),
        volume: "200-500",
        benefits: ["Labor Cost Reduction", "Consistency", "Fast Payback"],
        equipment: [
          window.t("roi_equip_stirfry", "Smart Wok") + " x2",
          window.t("roi_equip_fryer", "Deep Fryer") + " x1",
        ],
      ...
      },
      {
        ...
        country: "Indonesia",
        industry: window.t("app_cloud_kitchen", "Cloud Kitchen"),
        volume: "<200",
        benefits: ["Space Saving", "Labor Cost Reduction"],
        equipment: [
          window.t("roi_equip_stirfry", "Smart Wok") + " x1",
          window.t("roi_equip_induction", "Induction Cooker") + " x2",
          window.t("roi_equip_steamer", "Steamer") + " x1",
        ],
      ...
      },
      {
        ...
        country: "Vietnam",
        industry: window.t("app_central_kitchen", "Central Kitchen"),
        volume: "1000+",
        benefits: ["Consistency", "Labor Cost Reduction", "Fast Payback"],
        equipment: [
          window.t("roi_equip_stirfry", "Smart Wok") + " x4",
          window.t("roi_equip_steamer", "Steamer") + " x3",
          window.t("roi_equip_dishwasher", "Dishwasher") + " x2",
        ],
      ...
      },
      {
        ...
        country: "Thailand",
        industry: window.t("app_canteen", "Smart Canteen"),
        volume: "1000+",
        benefits: ["Consistency", "Fast Payback"],
        equipment: [
          window.t("roi_equip_stirfry", "Smart Wok") + " x3",
          window.t("roi_equip_steamer", "Steamer") + " x2",
          window.t("roi_equip_induction", "Induction Cooker") + " x4",
          window.t("roi_equip_fryer", "Deep Fryer") + " x2",
        ],
      ...
      },
      {
        ...
        country: "Philippines",
        industry: window.t("app_small_restaurant", "Small Restaurant"),
        volume: "<200",
        benefits: ["Labor Cost Reduction", "Space Saving", "Fast Payback"],
        equipment: [window.t("roi_equip_stirfry", "Smart Wok") + " x1"],
      ...
      },
      {
        ...
        equipment: [
          window.t("roi_equip_stirfry", "Smart Wok") + " x4",
          window.t("roi_equip_steamer", "Steamer") + " x4",
          window.t("roi_equip_dishwasher", "Dishwasher") + " x3",
        ],
