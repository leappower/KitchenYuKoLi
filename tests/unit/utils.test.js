/**
 * Unit tests for CommonUtils (src/assets/js/common.js — IIFE build)
 *
 * common.js is an IIFE that exposes functions on window.CommonUtils.
 * Tests destructure from global.CommonUtils after requiring the file.
 */

// Load the IIFE; it will execute and set global.CommonUtils.
require('../../src/assets/js/common.js');
