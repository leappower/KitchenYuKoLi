...
if (typeof window !== "undefined" && window.LANG_REGISTRY && window.LANG_REGISTRY.LANGUAGES) {
  ...
  var LANGUAGES = [
    ...
    // ── Phase 5: European ──
    {
      ...
      uiGroup: "european",
      sortOrder: 12,
      currency: { symbol: "€", code: "EUR", rate: 0.13, unit: "K" },
    },
    {
      code: "es",
      nativeName: "Español",
    ...
    },
    {
      ...
      uiGroup: "european",
      sortOrder: 15,
      currency: { symbol: "R$", code: "BRL", rate: 0.7, unit: "K" },
    },
    {
      code: "ru",
      nativeName: "Русский",
      ...
      uiGroup: "european",
      sortOrder: 16,
      currency: { symbol: "₽", code: "RUB", rate: 13, unit: "K" },
    },
    {
      code: "nl",
    ...
    },
    {
      ...
      uiGroup: "european",
      sortOrder: 18,
      currency: { symbol: "zł", code: "PLN", rate: 0.55, unit: "K" },
    },
    {
      code: "it",
      nativeName: "Italiano",
    ...
    },
    {
      ...
      uiGroup: "european",
      sortOrder: 20,
      currency: { symbol: "₺", code: "TRY", rate: 4.5, unit: "K" },
    },
    // ── Phase 6: SE Asia additional ──
    {
      code: "fil",
      nativeName: "Filipino",
      ...
      uiGroup: "southeast_asia",
      sortOrder: 21,
      currency: { symbol: "₱", code: "PHP", rate: 7.8, unit: "K" },
    },
    {
      code: "km",
      ...
      uiGroup: "southeast_asia",
      sortOrder: 22,
      currency: { symbol: "៛", code: "KHR", rate: 560, unit: "K" },
    },
    {
      code: "lo",
      nativeName: "ລາວ",
      ...
      uiGroup: "southeast_asia",
      sortOrder: 23,
      currency: { symbol: "₭", code: "LAK", rate: 3000, unit: "K" },
    },
    {
      code: "my",
      nativeName: "ဗမာစာ",
      ...
      uiGroup: "southeast_asia",
      sortOrder: 24,
      currency: { symbol: "K", code: "MMK", rate: 290, unit: "Lakh" },
    },
    {
      code: "he",
      nativeName: "עברית",
      ...
      uiGroup: "other",
      sortOrder: 25,
      currency: { symbol: "₪", code: "ILS", rate: 0.5, unit: "K" },
    },
  ];
} // 结束重复加载保护
