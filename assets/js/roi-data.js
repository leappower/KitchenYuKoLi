...
(function () {
  ...
  window.ROI_CASES = {
    cases: [
      {
        ...
        country: "Philippines",
        industry: window.uiText("app_chain_restaurant", "Chain Restaurant"),
        volume: "200-500",
        benefits: ["Labor Cost Reduction", "Consistency", "Fast Payback"],
        equipment: [
          window.uiText("roi_equip_stirfry", "Smart Wok") + " x2",
          window.uiText("roi_equip_fryer", "Deep Fryer") + " x1",
        ],
        savings: "55% labor cost cut, ROI in 8 months",
        image: "/assets/images/cases/manila/cover.webp",
      ...
      },
      {
        ...
        country: "Indonesia",
        industry: window.uiText("app_cloud_kitchen", "Cloud Kitchen"),
        volume: "<200",
        benefits: ["Space Saving", "Labor Cost Reduction"],
        equipment: [
          window.uiText("roi_equip_stirfry", "Smart Wok") + " x1",
          window.uiText("roi_equip_induction", "Induction Cooker") + " x2",
          window.uiText("roi_equip_steamer", "Steamer") + " x1",
        ],
        savings: "40% rent saved by downgrading kitchen space, same output",
        image: "/assets/images/cases/jakarta/cover.webp",
      ...
      },
      {
        ...
        country: "Vietnam",
        industry: window.uiText("app_central_kitchen", "Central Kitchen"),
        volume: "1000+",
        benefits: ["Consistency", "Labor Cost Reduction", "Fast Payback"],
        equipment: [
          window.uiText("roi_equip_stirfry", "Smart Wok") + " x4",
          window.uiText("roi_equip_steamer", "Steamer") + " x3",
          window.uiText("roi_equip_dishwasher", "Dishwasher") + " x2",
        ],
        savings: "60% labor reduction, 12-month full ROI",
        image: "/assets/images/cases/hcmc/cover.webp",
      ...
      },
      {
        ...
        country: "Thailand",
        industry: window.uiText("app_canteen", "Smart Canteen"),
        volume: "1000+",
        benefits: ["Consistency", "Fast Payback"],
        equipment: [
          window.uiText("roi_equip_stirfry", "Smart Wok") + " x3",
          window.uiText("roi_equip_steamer", "Steamer") + " x2",
          window.uiText("roi_equip_induction", "Induction Cooker") + " x4",
          window.uiText("roi_equip_fryer", "Deep Fryer") + " x2",
        ],
        savings: "Serving time cut from 45 to 20 min per meal window",
        image: "/assets/images/cases/bangkok/cover.webp",
      ...
      },
      {
        ...
        image: "/assets/images/cases/kl/cover.webp",
      ...
      },
      {
        ...
        country: "Philippines",
        industry: window.uiText("app_small_restaurant", "Small Restaurant"),
        volume: "<200",
        benefits: ["Labor Cost Reduction", "Space Saving", "Fast Payback"],
        equipment: [window.uiText("roi_equip_stirfry", "Smart Wok") + " x1"],
        savings: "₱18,000/month saved, ROI in 5 months",
        image: "/assets/images/cases/cebu/cover.webp",
      ...
      },
      {
        ...
        equipment: [
          window.uiText("roi_equip_stirfry", "Smart Wok") + " x4",
          window.uiText("roi_equip_steamer", "Steamer") + " x4",
          window.uiText("roi_equip_dishwasher", "Dishwasher") + " x3",
        ],
        savings: "35% kitchen footprint reduction, 50% fewer kitchen staff",
        image: "/assets/images/cases/surabaya/cover.webp",
      ...
      },
      {
        ...
        image: "/assets/images/cases/hanoi/cover.webp",
    ...
    filters: {
      industries: [
        window.uiText("app_small_restaurant", "Small Restaurant"),
        window.uiText("app_central_kitchen", "Central Kitchen"),
        window.uiText("app_chain_restaurant", "Chain Restaurant"),
        window.uiText("app_canteen", "Smart Canteen"),
        window.uiText("app_cloud_kitchen", "Cloud Kitchen"),
      ],
